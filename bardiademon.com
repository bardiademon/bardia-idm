...
<head>
	...
	<link rel="stylesheet" href="DOMAINstyle.css" type="text/css" />
</head>
<body>
<header>
	...
	<div class="div-code">
		<div class="div-code-header">
			<img src="DOMAINimages/ic-java.png" class="div-code-header-ic" alt="java" />
	...
	<div class="i-m-on-rows">
		<div>
			<a class="i-m-on-img-a" href="https://github.com/bardiademon" target="_blank">
				<img class="i-m-on-img" src="DOMAINimages/ic-github.png" alt="GitHub" />
				Github
			</a>
			<a class="i-m-on-img-a" href="https://gitlab.com/bardiademon" target="_blank">
				<img class="i-m-on-img" src="DOMAINimages/ic-gitlab.png" alt="GitLab" />
				GitLab
			</a>
		</div>
		<div>
			<a class="i-m-on-img-a" href="https://t.me/bardiademon" target="_blank">
				<img class="i-m-on-img" src="DOMAINimages/ic-telegram.png" alt="Telegram" />
				Telegram
			</a>
			<a class="i-m-on-img-a" href="https://instagram.com/bardiademon.ir" target="_blank">
				<img class="i-m-on-img" src="DOMAINimages/ic-instagram.png" alt="Instagram" />
				Instagram
			</a>
		</div>
	</div>
